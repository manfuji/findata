    ...
    <>
      <article className="prose">
        ...
        <p>
          ...
          <span className="font-bold">redux toolkit</span> and configured it for
          ...
          <div className="text-center">
            ...
            <div className="mockup-code text-justify mb-4">
              <pre className="my-0 py-0">
                <code>
                  {
                    '<a className="inline-block px-4 py-3 \n text-sm font-semibold text-center \n text-white uppercase transition duration-200 \n ease-in-out bg-teal-600 \n rounded-md cursor-pointer \n hover:bg-teal-700">Button</a>'
                  }
                </code>
              </pre>
            </div>
            <button className="inline-block  px-4 py-3  text-sm font-semibold text-center  text-white uppercase transition duration-200  ease-in-out bg-teal-600  rounded-md cursor-pointer  hover:bg-teal-700">
              Button
            </button>
          </div>
